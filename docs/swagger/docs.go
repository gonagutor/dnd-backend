    ...
    "paths": {
        ...
        "/v1/item/": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "If the response is successful you will receive the items and pagination data",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/responses.CorrectResponse"
                    ...
                    "403": {
                        "description": "The API can answer with a 403 if the token is invalid/malformed, the user has not verified their email yet or its not an admin",
                        "schema": {
                            "$ref": "#/definitions/responses.FailureResponse"
                        }
                    },
                    "500": {
                        "description": "If the server fails to get the items it will answer with a 500 code. Please report this error if you encounter it in production",
                        "schema": {
                            "$ref": "#/definitions/responses.FailureResponse"
                        }
                    }
        ...
        "/v1/item/create": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "If the response is successful you will receive a simple code and message indicating that the item has been created",
                        "schema": {
                            "$ref": "#/definitions/responses.CorrectResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "If the server fails to create the item it will answer with a 500 code. Please report this error if you encounter it in production",
                        "schema": {
                            "$ref": "#/definitions/responses.FailureResponse"
                        }
                    }
        ...
        "/v1/item/{item_id}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "If the response is successful you will receive a simple code and message indicating that the item has been edited",
                        "schema": {
                            "$ref": "#/definitions/responses.CorrectResponse"
                        }
                    },
                    ...
                    "403": {
                        "description": "The API can answer with a 403 if the token is invalid/malformed, the user has not verified their email yet or (if the user is trying to edit a public item) the user is not an admin",
                        "schema": {
                            "$ref": "#/definitions/responses.FailureResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "If the server fails to edit the item it will answer with a 500 code. Please report this error if you encounter it in production",
                        "schema": {
                            "$ref": "#/definitions/responses.FailureResponse"
                        }
                    }
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "If the response is successful you will receive a simple code and message indicating that the item has been deleted",
                        "schema": {
                            "$ref": "#/definitions/responses.CorrectResponse"
                        }
                    },
                    ...
                    "403": {
                        "description": "The API can answer with a 403 if the token is invalid/malformed. the user has not verified their email yet or (if the user is trying to delete public items) the user is not an admin",
                        "schema": {
                            "$ref": "#/definitions/responses.FailureResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "If the server fails to delete the item it will answer with a 500 code. Please report this error if you encounter it in production",
                        "schema": {
                            "$ref": "#/definitions/responses.FailureResponse"
                        }
                    }
        ...
        "/v1/item/{user_id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "The API can answer with a 403 if the token is invalid/malformed, the user has not verified their email yet or (if its not an admin) its trying to access to other user's items",
                        "schema": {
                            "$ref": "#/definitions/responses.FailureResponse"
                        }
                    },
